...
from acc_provision import acc_provision
import collections
__metaclass__ = type
...
def get_args(config, output, output_tar, aci_operator_cr):
    arg = {
        "config": config,
        "output": output,
        "output_tar": output_tar,
        "aci_operator_cr": aci_operator_cr,
        "apic_proxy": None,
        "apicfile": None,
        "apic": False,
        "delete": False,
...
def run_module():
    # define available arguments/parameters a user can pass to the
    # module
    module_args = dict(
    ...
    # not
    # want to make any changes to the environment, just return the
    # current
    ...
    output_file_tar = module.params['output_file'] + ".tar.gz"
    overrides = {}
    operator_cr_output = module.params['output_file'] + ".operator"
    args = get_args(config=module.params['input_file'], output=module.params['output_file'], output_tar=output_file_tar, aci_operator_cr=operator_cr_output)
    acc_provision.main(args)
    # use whatever logic you need to determine whether or not this
    # module
